...
MSG_ID_SENSOR_STREAM_CMD_REQUEST = 33,
MSG_ID_SENSOR_STREAM_CMD_RESPONSE = 34,
MSG_ID_SENSOR_STREAM_TRANSMIT_SHORT = 35,
...
MSG_ID_WHITE_LOG_REQUEST = 52
MSG_ID_WHITE_LOG_RESPONSE = 53

#Flash Logger<->MCU Developer UI
MSG_ID_FLASH_LOGGER_GET_CHUNK = 54
MSG_ID_FLASH_LOGGER_SET_CHUNK = 55
MSG_ID_FLASH_LOGGER_SAVE = 56
MSG_ID_FLASH_LOGGER_SYNC_CLOCK = 57
MSG_ID_FLASH_LOGGER_RESET = 58
MSG_ID_FLASH_LOGGER_LOAD = 59

#System Reset
MSG_ID_SYSTEM_RESET = 60
MSG_ID_ENERGY_CALCULATION_GET = 61


# MSG_ID_CONFIG_FPGA_READ_RESPONSE = 62
# MSG_ID_CONFIG_SENSOR_READ_RESPONSE = 63 
# MSG_ID_CONFIG_VARIANT_READ_RESPONSE = 64
# MSG_ID_FPGA_RESET = 65
